        ...
        <div class="admin-container">
            ...
            <div class="stats-grid">
                ...
                <div class="stats-card">
                    <h2>Tổng Số Lượng Sản Phẩm Đã Bán (Đơn đã hoàn thành)</h2>
                    <p class="stat-value" id="total-products-sold">Đang tải...</p>
                </div>
                
                <div class="stats-card">
                    <h2>Tổng Doanh Thu (Đơn đã hoàn thành)</h2>
                    <p class="stat-value revenue" id="total-revenue">Đang tải...</p>
                </div>

            </div>
            <p class="note">Lưu ý: Thống kê chỉ tính các đơn hàng có trạng thái là "Completed".</p>
        </div>
        <style>
